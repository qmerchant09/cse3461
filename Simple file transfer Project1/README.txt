QUANTEZ MERCHANT PROJECT 1: SIMPLE FILE TRANSFER README
...
- The client will prompt you for a file, after entering it in the client will talk to the server.
- The client will eventually ask for another filename, to end this loop enter DONE as the filename. 
